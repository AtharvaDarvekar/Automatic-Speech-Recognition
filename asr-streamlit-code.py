...
def load_wav2vec2_model():
    processor = Wav2Vec2Processor.from_pretrained("Athrensis/wav2vec2-large-xls-r-300m-hindi-colab-total")
    model = Wav2Vec2ForCTC.from_pretrained("Athrensis/wav2vec2-large-xls-r-300m-hindi-colab-total")
    return processor, model

# Load the Whisper processor and model
@st.cache_resource
def load_whisper_model():
    processor = AutoProcessor.from_pretrained("Athrensis/whisper-small-hindi-total")
    model = AutoModelForSpeechSeq2Seq.from_pretrained("Athrensis/whisper-small-hindi-total")
    return processor, model
...
def main():
    ...
    model_option = st.selectbox("Select Model", ["Wav2Vec2", "Whisper"])
